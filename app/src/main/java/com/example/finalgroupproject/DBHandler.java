...
// Adding new User Details
    void insertUserDetails(String name, String comment){
...
// Insert the new row, returning the primary key value of the new row
    ...
    public ArrayList<HashMap<String, String>> GetUsers(){
        ...
        String query = "SELECT name, comment FROM "+
                TABLE_Users;
        Cursor cursor = db.rawQuery(query,null);
        while (cursor.moveToNext()){
            HashMap<String,String> user = new HashMap<>();
            user.put("name",cursor.getString(cursor.getColumnIndex(KEY_NAME)));
            user.put("comment",cursor.getString(cursor.getColumnIndex(KEY_COM)));
            userList.add(user);
        }
        return userList;
    }
    ...
    public ArrayList<HashMap<String, String>> GetUserByUserId(int userid){
        ...
        Cursor cursor = db.query(TABLE_Users, new String[]{KEY_NAME,
                        KEY_COM}, KEY_ID+ "=?",new String[]{String.valueOf(userid)},null, null,
                null, null);
    ...
    // Update User Details
    public int UpdateUserDetails(String comment, int
            id){
        SQLiteDatabase db = this.getWritableDatabase();
